...
import { EditOutlined, DeleteOutlined, AttachFileOutlined, MicOutlined, GifBoxOutlined, ImageOutlined, MoreHorizOutlined, Palette } from '@mui/icons-material';
        ...
        <WidgetWrapper>
            <FlexBetween gap={"1.5rem"}>
                ...
                <InputBase placeholder="What's on your mind..." onChange={(e) => setPost(e.target.value)}
                    value={post} sx={{ width: "100%", backgroundColor: palette.neutral.light, borderRadius: "2rem", padding: "1rem 2rem" }}
                />
            </FlexBetween>
            {isImage && (
